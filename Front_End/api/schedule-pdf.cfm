...
Author: Rasti Toscak
Date: 2025-11-24
Version: 4.0 - Added cosmic purple theme to match website
================================================================================
--->
...
<cftry>
    ...
    <!--- Set file path for temporary storage --->
    <cfset pdfFileName = "PASC_Conference_Schedule.pdf">
    <cfset pdfDirectory = expandPath("/assets/documents/temp/")>
    <cfset pdfFilePath = pdfDirectory & pdfFileName>

    <!--- Ensure temp directory exists --->
    <cfif NOT directoryExists(pdfDirectory)>
        <cfdirectory action="create" directory="#pdfDirectory#">
    </cfif>
    ...
    <cfdocument format="pdf"
        ...
        <div style="margin-top: 25px; background-color: ##1a1f3a; padding: 15px; text-align: center; font-family: Arial, sans-serif;">
            ...
            <div style="font-size: 8pt; color: ##888888; margin-top: 2px;">
                Schedule generated #dateFormat(now(), "mmmm dd, yyyy")#
            </div>
        </div>
        </cfoutput>
    ...
    <cfcontent type="application/pdf" file="#pdfFilePath#" deletefile="false" reset="true">
